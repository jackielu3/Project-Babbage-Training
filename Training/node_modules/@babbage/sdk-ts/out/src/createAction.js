...
exports.validateCreateActionOptions = exports.createAction = void 0;
...
async function createAction(args) {
    ...
    if (args.acceptDelayedBroadcast !== undefined)
        options.acceptDelayedBroadcast = args.acceptDelayedBroadcast;
...
function validateCreateActionOptions(options) {
    options || (options = {});
    if (options.acceptDelayedBroadcast === undefined)
